...
//	MWPCBreite = 140*cm; // fuer bessere Transfermatrix
	...
	SciFiKanalzahl = 24*96; // 24 Tripleboards a 96 Kanäle
	SciFiKanalzahl_th = SciFiKanalzahl; // +0 Tripleboards a 96 Kanäle
	SciFiKanalzahl_y = 2000; // einzelne Kanäle mit SSPMTs
//	SciFiKanalzahl_y = 20; // 5 Tripleboards a 96 Kanäle
